...
public class SCRUMSprintDeleteStepDefinition {
	...
	protected WebDriver driver; //ezzel kommunikal a klienssel/bongeszovel
	...
	public void I_edit_the_scrum_list_s_first_story() throws Throwable { // betolti a bongeszot
	    // Express the Regexp above with the code you wish you had
		driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
		driver.get("http://localhost:8080/");
		WebElement firstItem = driver.findElement(By.id("story-list"));
		List<WebElement> children = (List<WebElement>) firstItem.findElements(By.className("well"));
	...
	public void I_should_get_result_in_new_stories_list() throws Throwable {
		WebElement firstItem = driver.findElement(By.id("story-list"));
		List<WebElement> children = (List<WebElement>) firstItem.findElements(By.className("well"));
		assertTrue("No element in the List",children.size() == childrenSize - 1);
	}
